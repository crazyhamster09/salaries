...
st.write("Рассчитаем реальные зарплаты на основе данных о номинальной зарплате и годовой инфляции")
...
st.write("Рассчитаем темп прироста реальных зарплат, сравнив значение каждого года с предыдущим")
